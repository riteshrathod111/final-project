...
import static com.rishav.firebasedemo.chatwindo.reciverIImg;
import static com.rishav.firebasedemo.chatwindo.senderImg;
...
public class messagesAdpter extends RecyclerView.Adapter {
    ...
    private void addNotification(String postid, String userId) {
        // Use the userId parameter instead of firebaseUser.getUid()
        HashMap<String, Object> map = new HashMap<>();
        map.put("userid", firebaseUser.getUid()); // Sending notification to the user being followed
        map.put("text", "Send a new message to you.");
        map.put("postid", "");
